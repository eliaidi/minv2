...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>${cache['SYS_TITLE'][0].value}-系统管理员主页</title>
							...
							<div id="lbox_middlecenter">
								...
								<div id="lbox_middleleft">
									...
									<div id="lbox_middleright">
										<div id="bs_left">
											<IFRAME scrolling="no" width="100%" height="670px" frameBorder="0" id="frmleft" name="frmleft" src="${urlctx}/users/iframePage/navigationDrawerIframe.jsp" allowTransparency="true"></IFRAME>
										</div>
							...
							<div id="rbox">
								...
								<div id="rbox_middleleft ">
									...
									<div id="rbox_middleright ">
										<!--<div id="bs_right " >  -->
										<iframe scrolling="no" width="100%"  height="670px " frameBorder="0" id="frmright" name="frmright" src="${urlctx }findAllDictDepart.action"  allowTransparency="true"></iframe>
										<!--</div>   -->
									</div>
