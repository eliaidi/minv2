...
<base href="<%=basePath%>" />
<!-- 验证用户自定义 -->
<script type="text/javascript"   src="${ctx}/js/users/addDepartUsersDialog_script.js.jsp"></script>
<!-- 通用的拼音验证 -->
...
<body>
	...
	<form action="" target="frmright" method="post"
		...
		<!-- 判断是否为修改页面，删除session(usersPrivs) -->
			...
			<tr>
				<td>角色：</td>
				<td><input type="button" value="请选择" id="roleInUsersDepartListCK" name="roleInUsersDepartListCK" style="width:45px;"  onclick="checkRoleInUsersDepart();"/>
				...
				/>
				<!-- <select  onchange='' name="usersRolePrivs.RolePrivs.id" id="role">
			...
			<tr>
				...
				<td colspan="3" style="text-align:left"><textarea rows="20"
						cols="10" name="remark" id="remark"></textarea>
				</td>
			</tr>
			<tr>
