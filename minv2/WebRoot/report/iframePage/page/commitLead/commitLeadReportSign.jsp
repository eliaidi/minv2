...
<html>
	...
	<head>
		...
		<!-- 引用以封装的复选框js							结束 -->
		<!-- 引用交车工长js									开始 -->
		<script type="text/javascript" src="${urlctx}js/report/page/commitLead/commitLeadReportSign_script.js"></script>
		<!-- 引用交车工长js										结束 -->
	...
	<body>
		...
		<button id="report" style="position: fixed; left:145px; top: 5px;" ><span class="icon_print">报活</span></button>
		<input type="hidden" value="${param.planDateId}" id="planDateId"/>
		<table width="100%" height="" class="tableStyle" id="checkboxTable" useCheckBox="false" style="margin-top: 30px;">
			<tr align="center">
				<th class="ver01"><input type="checkbox" id="checkAll"/></th>
			...
			<c:forEach var="jtReport" items="${jtReportList}">
				<tr align="center">
					<td class="ver01">
						<c:if test="${jtReport.recordStatus == leadCheckFlag && jtReport.commitLeadCheck == needCheck }">
