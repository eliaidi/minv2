...
<html>
	...
	<head>
		...
		<!-- 引用以封装的复选框js							结束 -->
		<!--  引用验收员js									开始-->
		<script type="text/javascript" src="${urlctx}js/report/page/acceptance/acceptanceReportSign_script.js"></script>
		<!--  引用验收员js										结束-->
	...
	<body>
		...
		<table width="100%" height="" class="tableStyle" id="checkboxTable" useCheckBox="false" style="margin-top: 30px;">
			...
			<c:forEach var="jtReport" items="${jtReportList}">
				<tr align="center">
					<td class="ver01">
						<c:if test="${jtReport.acceptanceCheck == needCheck && jtReport.acceptanceUsers == null}">
