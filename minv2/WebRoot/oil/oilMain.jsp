...
<head>
    ...
    <title>${cache['SYS_TITLE'][0].value}-油水化验主页</title>
	...
	<!--弹出窗口（分离版）			start-->
	<script type="text/javascript" src="${ctx }/js/zDialog_split/zDialog.js"></script>
	<script type="text/javascript" src="${ctx }/js/zDialog_split/zDrag.js"></script>
	<!--弹出窗口（分离版）				end-->
	<!-- 导航栏插件css样式				开始 -->
						...
						<div id="lbox_middlecenter">
							...
							<div id="lbox_middleleft">
								...
								<div id="lbox_middleright">
									<div id="bs_left">
										<IFRAME scrolling="no" width="100%" height="100%"  frameBorder="0" id="frmleft" name="frmleft" src="${urlctx}oil/iframePage/navigationDrawerIframe.jsp"  allowTransparency="true"></IFRAME>
									</div>
							...
							<div id="rbox_middlecenter"> 
								...
								<div id="rbox_middleleft">
									...
									<div id="rbox_middleright">
										<div id="bs_right">
										    <IFRAME scrolling="no" width="100%"  height="500px" frameBorder="0" id="frmright" name="frmright" src="#"  allowTransparency="true"></IFRAME>
										</div>
									</div>
			...
			<div id="bs_footcenter">
				<div id="bs_footleft">
					<div id="bs_footright" class="white">
						 骁睿公司COPYRIGHT 2015 @ www.xiaorui123.com
					</div>
				</div>
			</div>
		</div>
