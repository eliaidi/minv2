...
<%@ include file="/common/taglibs.jsp" %>
	<head>
		...
		<!-- 显示股道图应用的js								开始 -->
		<script type="text/javascript" src="${ctx}/mainframe/js/bsFormat.js"></script>
		<!-- 显示股道图应用的js								结束-->
		<!--
		<script type="text/javascript" src="${ctx}/mainframe/js/menu/jkmegamenu.js"></script>
		 -->
		<script type="text/javascript" src="${ctx}/gdt/iframePage/guangzhou_gdt/js/guangzhou_gdt_script.js"></script>
		
		 <link rel="stylesheet" type="text/css" href="${ctx}/gdt/iframePage/guangzhou_gdt/css/guangzhou_gdt.css" />
