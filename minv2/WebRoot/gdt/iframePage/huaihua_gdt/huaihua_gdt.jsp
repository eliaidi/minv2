...
<%@ include file="/common/taglibs.jsp" %>
	<head>
		...
		<script type="text/javascript" src="${ctx}/mainframe/js/menu/jkmegamenu.js"></script>
		 -->
		<script type="text/javascript" src="${ctx}/gdt/iframePage/huaihua_gdt/js/huaihua_gdt_script.js"></script>
		
		<link rel="stylesheet" type="text/css" href="${ctx}/gdt/iframePage/huaihua_gdt/css/huaihua_gdt.css" />
