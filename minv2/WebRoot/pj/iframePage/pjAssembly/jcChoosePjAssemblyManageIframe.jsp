    ...
    <div id="minv2_firstUnitManageIframe_mainDiv" class="minv2_firstUnitManageIframe_mainDiv_class">
    	 <!--左边菜单DIV                                                                     开始-->
            <div id="minv2_firstUnitManageIframe_leftDiv" class="minv2_firstUnitManageIframe_leftDiv_class">
            	<!-- 盒子模型上方                                                            开始 -->
				<div class="box2" panelWidth="270" panelHeight="520" panelTitle="左侧菜单页面" overflow="auto" >
					...
					<div id="scrollContent" class="border_gray" style="width:235px">
            ...
            <div id="minv2_firstUnitManageIframe_rightDiv" class="minv2_firstUnitManageIframe_rightDiv_class" style="position:relative;left:40px;">
            	<iframe id="minv2_firstUnitManageIframe_contentIframe" name="minv2_firstUnitManageIframe_rightIframe" class="minv2_firstUnitManageIframe_rightIframe_class" scrolling="no" frameborder="no" src="${urlctx }pj/iframePage/pjAssembly/rightPage.jsp" width="100%" height="100%"></iframe>
            </div> 
            <!--右边内容DIV                                                                  结束-->
    </div>
