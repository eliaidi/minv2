			...
			<table class="tableStyle" useMultColor="false" useCheckBox="true">
				...
				<c:forEach var="pjSSInfo"  items="${spm.data}" varStatus="countPJ">
					    <tr>
							...
							<td width="8%"><a href="enterSignByQCOfCheckForPjFix.action?id=${pjSSInfo.id}"><span>进入签认</span></a></td>
						</tr>
				</c:forEach>
			</table>
		</div>
...
<!-- 自定义js -->
<script type="text/javascript" src="${ctx}/js/pjFix/checkFixPj/qc/maintenancePjManagerIframe_script.js"></script>
</html>