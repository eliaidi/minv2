...
<html>
	...
	<body>
		...
		<button type="button" id="sign">签认</button>&nbsp;&nbsp;&nbsp;
		...
		<div id="scrollContent" class="border_gray">
			<table class="tableStyle" useMultColor="false" useCheckBox="true">
				...
				<tr>
					...
					<td width="15%">
					<span class="text_slice" style="width:130px"  title="检修人信息如下：</br>&nbsp;&nbsp;&nbsp;${checkItem.fixUsersIds}">${checkItem.fixUsersIds}</span>
					</td>
	...
	<script type="text/javascript" src="${urlctx }/js/pjFix/checkFixPj/qc/signManagerIframe.js"></script>
</html>