...
<html>
	...
	<body>
		<div class="box2" panelTitle="验收员卡控" roller="false">
			<!-- 条件查询显示区										开始 -->
			<table>
				<tr>
		...
		<div id="scrollContent" class="border_gray">
			<table class="tableStyle" useMultColor="false" useCheckBox="true">
				...
				<tr>
					...
					<td width="15%"><a href="queryPjSDInfoByAcceptancePjForPjFix.action
						?pjName=${ssInfo.pjName}&fixItemQueryFlag=<%=Constants.PJ_SDIS_DTO_FIX_ITEM_QUERY_FALG_UN_SIGNALL%>
						&roleType=<%=Constants.ROLE_TYPE_ACCEPTANCE%>" target="_blank">
...
src="${ctx}/js/pjFix/checkFixPj/acceptance/dynamicPjListManagerIframe_script.js"></script>
</html>