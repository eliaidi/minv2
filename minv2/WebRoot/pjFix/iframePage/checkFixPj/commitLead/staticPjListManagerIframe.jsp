...
<html>
	...
	<body>
		<div class="box2" panelTitle="交车工长卡控" roller="false">
			<!-- 条件查询显示区										开始 -->
			<table>
				<tr>
		...
		<div id="scrollContent" class="border_gray">
			<table class="tableStyle" useMultColor="false" useCheckBox="true">
				...
				<tr>
					...
					<td width="15%"><a href="queryPjSDInfoByCommitLeadPjForPjFix.action
						?pjName=${ssInfo.pjName}&fixItemQueryFlag=<%=Constants.PJ_SDIS_DTO_FIX_ITEM_QUERY_FALG_UN_SIGNALL%>
						&roleType=<%=Constants.ROLE_TYPE_COMMIT_LEAD%>">
						-<font color="red">${staySignPjMap[ssInfo.id]}</font>-个待签配件</a>
					</td>
					<td width="8%"><a href="#" title="点击我进入待签配件页面"><font color="green">${fixingPjMap[ssInfo.id] }</font></a></td>
				</tr>
				</c:forEach>
...
src="${ctx}/js/pjFix/checkFixPj/commitLead/dynamicPjListManagerIframe_script.js"></script>
