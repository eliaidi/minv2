...
<html>
	...
	<body>
		<div class="box2" panelTitle="待签配件（技术员）" roller="false">
			<table>
				<tr>
			...
			<table class="tableStyle" useMultColor="false" useCheckBox="true">
				...
				<c:forEach var="pjSSInfo"  items="${spm.data}" varStatus="countPJ">
					    <tr>
							...
							<td width="8%"><a href="enterSignByTechnicianOfCheckForPjFix.action?id=${pjSSInfo.id}"><span>进入签认</span></a></td>
						</tr>
				</c:forEach>
			</table>
		</div>
...
src="${ctx}/js/pjFix/checkFixPj/technician/technicianFixingPjManagerIframe_script.js"></script>
</html>