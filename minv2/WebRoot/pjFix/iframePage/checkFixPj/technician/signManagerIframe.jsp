...
<html>
	...
	<body>
		<div class="box2" panelTitle="进入签认（技术员）" roller="false">
		<button id="sign">签认</button>&nbsp;&nbsp;&nbsp;
		配件名称：<font color="blue">${psdi.pjStoreStaticInfo.pjName }</font>&nbsp;&nbsp;&nbsp;
		配件编号：<font color="blue">${psdi.pjdCode}</font>&nbsp;&nbsp;&nbsp;
		...
		<div id="scrollContent" class="border_gray">
			<table class="tableStyle" useMultColor="false" useCheckBox="true">
				...
				<tr>
					<td width="5%"><input type="checkbox" name="itemId" value="${checkItem.id }"/>${checkItemIndex.index+1 }</td>
					<td width="20%">
					...
					<td width="15%">
					<span class="text_slice" style="width:130px"  title="检测项目信息如下：</br>&nbsp;&nbsp;&nbsp;${checkItem.fixUsersIds} ${checkItem.fixTime}">${checkItem.fixUsersIds} ${checkItem.fixTime}</span>
					</td>
					<td width="5%">${checkItem.fixCondition}</td>
					<td width="15%">
	...
	<script type="text/javascript" src="${urlctx }/js/pjFix/checkFixPj/technician/signManagerIframe.js"></script>
</html>