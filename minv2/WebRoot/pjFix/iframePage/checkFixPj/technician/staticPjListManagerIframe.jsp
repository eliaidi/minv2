...
<html>
	...
	<body>
		<div class="box2" panelTitle="技术员卡控" roller="false">
			<!-- 条件查询显示区										开始 -->
			<table>
				<tr>
		...
		<div id="scrollContent" class="border_gray">
			...
			<c:forEach var="ssInfo" items="${spm.data}" varStatus="ssInfoIndex">
				<tr>
					...
					<td width="15%"><a href="queryPjSDInfoByTechnicianPjForPjFix.action
						?pjName=${ssInfo.pjName}&fixItemQueryFlag=<%=Constants.PJ_SDIS_DTO_FIX_ITEM_QUERY_FALG_UN_SIGNALL%>
						&roleType=<%=Constants.ROLE_TYPE_TECHNICIAN%>">
...
src="${ctx}/js/pjFix/checkFixPj/technician/dynamicPjListManagerIframe_script.js"></script>
</html>