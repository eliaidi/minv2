...
<html>
	<head>
		...
		<!-- 引用js文件				开始 -->
   		 <script type="text/javascript" src="${ctx}/js/pjFix/checkFixPj/fixUsers/checkSignRecognitionDialog_script.js"></script>
    	<!-- 引用js文件				结束 -->
  </head>
  ...
  <body>
		<div class="" panelTitle="检查项目签认" >
			...
			<table class="tableStyle" style="width:450px;height:100px">
