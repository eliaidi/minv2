...
<head>
	<title>(工人)报活</title>
		...
		<!-- 自定义js							开始 -->
		<script type="text/javascript" src="${urlctx}js/zx/itemSignPage/fixUsers/fixUsersWorkerRatify_script.js"></script>
		<!-- 自定义js	结束 -->
...
<body>
	    ...
	    <input type="hidden" id="usersId" value="${loginUser.id}"/>
	    <input type="hidden" id="proteamId" value="${loginUser.dictProteam.id}"/>
		<div id="tab_menu"></div>
