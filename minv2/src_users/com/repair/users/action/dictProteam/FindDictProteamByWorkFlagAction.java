...
/**
* @ClassName: FindByWorkFlagAction
* @Description: TODO(根据班组，小辅修、中修判别字段，查询（0、不修；1、小辅修；2、中修；3、小辅修/中修）)
* @author 唐鹏
* @version V1.0  
* @date 2015-8-5 上午08:36:31
 */
public class FindDictProteamByWorkFlagAction extends BaseAction{
	
    private DictProteamService dictProteamService;
    private DictProteam dictProteam;
    
    public String execute() throws Exception {
    	List<DictProteam> list=dictProteamService.findDictProteamByWorkFlag(dictProteam.getWorkFlag());
