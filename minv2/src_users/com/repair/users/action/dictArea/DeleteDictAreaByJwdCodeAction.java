 ...
 * 
 * @Package com.repair.users.action.dictArea
 * @Description: TODO(地区表(dictArea)，通过jwdCode删除的action)
 * @author lxb
 * @datetime 2015-8-4 下午2:15
 */
public class DeleteDictAreaByJwdCodeAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		System.out.println("通过jwdCode删除dictArea数据进行中....");
