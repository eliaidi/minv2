...
/**
* @ClassName: DictProteamService
* @Description: TODO(班组类(DictProteamService)接口)
* @author 唐鹏
* @version V1.0  
* @date 2015-8-4 上午10:50:16
 */
public interface DictProteamService extends BaseDao<DictProteam>{
