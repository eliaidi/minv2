...
* @Description: TODO 配件仓库动态信息记录表，出库入库记录  dao层
* @author 周云韬
* @version V1.0  
* @date 2015-8-31 下午2:55:38
 */
public interface PjSDInfoRecordDao extends BaseDao<PjSDInfoRecord>{
	
	/**
	 *   多条件查询 动态配件出库入库记录，具体查询条件请参考pj/iframePage/pjSDInfoRecord/pjSDInfoRecordManage.jsp页面
