...
* @Description: TODO(多条件查询动态配件)
* @author 周云韬
* @version V1.0  
* @date 2015-9-25 上午10:53:00
 */
public class QueryPjSDInfoByChooseFixPjAction extends ActionSupport implements ModelDriven<PjStoreDynamicInfoSearchDto>{
	...
	public String execute() throws Exception {
		//判断检修、待修等状态
		ServletActionContext.getRequest().setAttribute("pjSDInfoPjdStatus", Constants.PJ_STORE_DYNAMIC_INFO_PJD_STATUS);
		...
		//专业信息
		List<DictPjFirstUnit> firstUnitList = dictPjFirstUnitForPjFixService.findAllDictPjFirstUnit();
		ServletActionContext.getRequest().setAttribute("firstUnitList", firstUnitList);
		//配件所在仓库信息
