...
/**
* @ClassName: QueryPjSSInfoByFixUsersAction
* @Description: TODO(配件检修，选择配件，（检修员）通过静态配件查询所有数据)
* @author 唐鹏
* @version V1.0  
* @date 2015-9-22 上午08:57:21
 */
public class QueryPjSSInfoByFixUsersAction extends BaseAction implements ModelDriven<PjStoreStaticInfoSearchDto>{
	...
	public String execute() throws Exception {
		...
		for (PjStoreStaticInfo pssi : pssiList) {
			...
			dto.setRoleType(Constants.ROLE_TYPE_FIX_USERS);
