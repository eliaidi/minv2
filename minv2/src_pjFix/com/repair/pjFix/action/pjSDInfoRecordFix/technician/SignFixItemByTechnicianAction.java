package com.repair.pjFix.action.pjSDInfoRecordFix.technician;
...
/**
* @ClassName: SignFixItemByTechnicianAction
* @Description: TODO  技术员签认检修项目
* @author 周云韬
* @version V1.0  
* @date 2015-9-30 上午9:41:00
 */
public class SignFixItemByTechnicianAction extends BaseAction{
	...
	public String execute() throws Exception {
		...
		try{
			...
			for (String tempId : idArr) {
				...
				//修改卡控时间
				fixCheck.setTechnicianCheckTime(Constants.TIME_STAMP_SYSTEM_DATE);
				fixCheck.setTechnicianUsers(loginUsers);
	...
	public boolean isCanSign(PjSDInfoRecordFix fix){
		...
		//如果技术员不需要卡控
		if(fixCheck.getTechnicianCheck() == Constants.JC_INFORMATION_JC_STATUS_ZERO){
			return false;
		}
		return true;
	}
