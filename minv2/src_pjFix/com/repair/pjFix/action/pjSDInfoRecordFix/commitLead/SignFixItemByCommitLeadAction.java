package com.repair.pjFix.action.pjSDInfoRecordFix.commitLead;
...
/** 
* @ClassName: SignFixItemByCommitLeadAction
* @Description: TODO  交车工长签认检修项目
* @author 周云韬
* @version V1.0  
* @date 2015-9-30 上午9:41:00
 */
public class SignFixItemByCommitLeadAction extends BaseAction{
	...
	public String execute() throws Exception {
		...
		try{
			...
			for (String tempId : idArr) {
				...
				//修改检修项目节点
				fix.setFixCheckNode(Constants.PJ_SDI_RECORD_FIX_FIX_CHECK_NODE_FOUR);
				
				//修改卡控时间
				fixCheck.setCommitLeadCheckTime(Constants.TIME_STAMP_SYSTEM_DATE);
				fixCheck.setCommitLeadUsers(loginUsers);
	...
	public boolean isCanSign(PjSDInfoRecordFix fix){
		...
		//如果交车工长不需要卡控
		if(fixCheck.getCommitLeadCheck() == Constants.PJ_SDIRF_CHECK_CHECK_STATU_ZERO){
			return false;
		}
		return true;
	}
